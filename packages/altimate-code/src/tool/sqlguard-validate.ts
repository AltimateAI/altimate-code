...
export const SqlGuardValidateTool = Tool.define("sqlguard_validate", {
  description:
    "Validate SQL syntax and schema references using the Rust-based sqlguard engine. Checks if tables/columns exist in the schema and if SQL is valid for the target dialect.",
  parameters: z.object({
