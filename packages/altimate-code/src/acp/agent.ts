...
import type { AssistantMessage, Event, AltimateClient, SessionMessageResponse } from "@altimate/cli-sdk/v2"
...
export namespace ACP {
  ...
  export async function init({ sdk: _sdk }: { sdk: AltimateClient }) {
    return {
