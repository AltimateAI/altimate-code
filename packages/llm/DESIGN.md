...
- Secondary audience: Altimate Code and other durable agent runtimes
...
Altimate Code and other durable runtimes need to own persistence, tool settlement,
...
Altimate Code should migrate to `generateTurn` / `streamTurn`, preserving its durable
