...
// (Re-homed from the deleted location-layer.ts during the v1.18.10 merge.)
...
export const refreshNode = makeLocationNode({
  ...
  layer: disableProjectCopyRefresh ? Layer.effectDiscard(Effect.void) : Layer.effectDiscard(refreshAfterBoot),
