export const dict = {
  ...
  "desktop.menu.help.documentation": "Documentation d'Altimate Code",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI Altimate Code est manquant. Essayez de réinstaller l'application de bureau.",
