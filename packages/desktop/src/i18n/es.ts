export const dict = {
  ...
  "desktop.menu.help.documentation": "Documentación de Altimate Code",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de Altimate Code. Intenta reinstalar la aplicación de escritorio.",
