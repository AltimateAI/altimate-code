export const dict = {
  ...
  "desktop.menu.help.documentation": "وثائق Altimate Code",
  ...
  "desktop.cli.error.sidecarMissing": "ملف Altimate Code CLI الثنائي مفقود. حاول إعادة تثبيت تطبيق سطح المكتب.",
