export const dict = {
  ...
  "desktop.menu.help.documentation": "Altimate Code Dokumentacija",
  ...
  "desktop.cli.error.sidecarMissing":
    "Nedostaje binarna datoteka Altimate Code CLI-a. Pokušaj ponovo instalirati desktop aplikaciju.",
