export const dict = {
  ...
  "desktop.menu.app": "Altimate Code",
  ...
  "desktop.menu.help.documentation": "Altimate Code Documentation",
  ...
  "desktop.cli.error.sidecarMissing": "Altimate Code CLI binary is missing. Try reinstalling the desktop app.",
