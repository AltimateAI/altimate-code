export const dict = {
  ...
  "desktop.menu.help.documentation": "Altimate Code Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "Altimate Code CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
