export const dict = {
  ...
  "desktop.menu.help.documentation": "Altimate Code Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing": "Altimate Code CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",
