export const dict = {
  ...
  "desktop.menu.help.documentation": "Dokumentacja Altimate Code",
  ...
  "desktop.cli.error.sidecarMissing":
    "Brakuje pliku binarnego Altimate Code CLI. Spróbuj ponownie zainstalować aplikację na komputer.",
