...
// altimate_change — release asset names match the publish workflow's
...
const targets = [
  ...
  { key: "windows-x86_64-nsis", asset: "altimate-code-desktop-windows-x64.exe" },
  { key: "darwin-x86_64-app", asset: "altimate-code-desktop-darwin-x64.app.tar.gz" },
  {
    key: "darwin-aarch64-app",
    asset: "altimate-code-desktop-darwin-aarch64.app.tar.gz",
  },
]
