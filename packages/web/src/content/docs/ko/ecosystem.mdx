---
title: 생태계
description: Altimate Code로 구축된 프로젝트와 통합.
---

Altimate Code를 기반으로 만들어진 커뮤니티 프로젝트 모음입니다.

:::note
이 목록에 Altimate Code 관련 프로젝트를 추가하고 싶다면 PR을 제출하세요.
:::
...
| 이름                                                                                               | 설명                                                                                            |
| -------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | git sync와 live preview를 지원하는 격리된 Daytona sandbox에서 Altimate Code 세션을 자동 실행합니다.  |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Wakatime으로 Altimate Code 사용량을 추적합니다.                                                      |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Altimate Code 세션에 데스크톱 알림과 사운드 알림을 제공합니다.                                       |
| [opencode-notifier](https://github.com/mohak34/opencode-notifier)                                  | permission, 완료, 오류 이벤트에 대한 데스크톱 알림과 사운드 알림을 제공합니다.                  |
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Altimate Code 맥락을 기반으로 Zellij session 이름을 AI로 자동 지정합니다.                            |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | skill 탐색과 주입을 통해 Altimate Code agent가 필요 시 prompt를 lazy load하도록 합니다.              |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Altimate Code 작업 완료 시점을 native OS 알림으로 알려줍니다.                                        |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Altimate Code용 git worktree를 손쉽게 사용할 수 있도록 돕습니다.                                     |
...
| 이름                                                                                       | 설명                                                                   |
| ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | SDK 기반으로 Altimate Code 세션을 제어하는 Discord bot입니다.               |
| [opencode.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | API 기반 editor-aware prompt를 제공하는 Neovim plugin입니다.           |
| [portal](https://github.com/hosenur/portal)                                                | Tailscale/VPN 환경에서 Altimate Code를 쓰기 위한 mobile-first 웹 UI입니다.  |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Altimate Code plugin 개발을 위한 템플릿입니다.                              |
...
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Altimate Code용 Web/Desktop App 및 VS Code Extension입니다.                 |
| [Altimate Code-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian UI에 Altimate Code를 내장하는 Obsidian plugin입니다.               |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Altimate Code 기반의 Claude Cowork 대체 오픈소스 프로젝트입니다.            |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | 휴대형 격리 프로필을 지원하는 Altimate Code extension manager입니다.        |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Altimate Code용 Desktop/Web/Mobile/Remote client app입니다.                 |
