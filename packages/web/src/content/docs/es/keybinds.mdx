...
Altimate Code tiene una lista de combinaciones de teclas que puede personalizar a través de `tui.json`.
...
Altimate Code usa una tecla `leader` para la mayoría de las combinaciones de teclas. Esto evita conflictos en tu terminal.
