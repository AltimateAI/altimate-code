...
Altimate Code has a list of keybinds that you can customize through `tui.json`.
...
Altimate Code uses a `leader` key for most keybinds. This avoids conflicts in your terminal.
