...
Altimate Code ha una lista di scorciatoie che puoi personalizzare tramite `tui.json`.
...
Altimate Code usa un tasto `leader` per la maggior parte delle scorciatoie. Questo evita conflitti nel terminale.
