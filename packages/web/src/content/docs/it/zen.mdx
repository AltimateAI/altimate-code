---
title: Zen
description: Lista curata di modelli fornita da Altimate Code.
---
...
Altimate Code Zen è una lista di modelli testati e verificati dal team di Altimate Code.

:::note
Altimate Code Zen è attualmente in beta.
:::

Zen funziona come qualunque altro provider in Altimate Code. Accedi a Altimate Code Zen e ottieni la tua chiave API. È **completamente opzionale**: non devi usarlo per usare Altimate Code.
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con Altimate Code.
:::
...
Altimate Code Zen e un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

Altimate Code Zen funziona come qualunque altro provider in Altimate Code.

1. Accedi a **<a href={console}>Altimate Code Zen</a>**, aggiungi i dettagli di fatturazione e copia la chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona Altimate Code Zen e incolla la chiave API.
...
Il [model id](/docs/config/#models) nella config di Altimate Code usa il formato `opencode/<model-id>`. Per esempio, per GPT 5.2 Codex useresti `opencode/gpt-5.2-codex` nella config.
...
- MiniMax M2.5 Free e disponibile su Altimate Code per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth gratuito su Altimate Code per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
...
Abbiamo creato Altimate Code Zen per:
...
4. Evitare **lock-in** permettendoti di usarlo con qualunque altro agente di coding e lasciandoti sempre usare anche altri provider con Altimate Code.
