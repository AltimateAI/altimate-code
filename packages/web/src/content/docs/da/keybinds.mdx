...
Altimate Code har en liste over nøglebindinger, som du kan tilpasse gennem `tui.json`.
...
Altimate Code bruger en `leader` nøgle til de fleste smagsbindinger. Dette undgår konflikter i din terminal.
