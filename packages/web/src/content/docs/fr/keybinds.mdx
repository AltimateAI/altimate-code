...
Altimate Code a une liste de raccourcis clavier que vous pouvez personnaliser via la configuration Altimate Code.
...
Altimate Code utilise une touche `leader` pour la plupart des raccourcis clavier. Cela évite les conflits dans votre terminal.
