...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new AltimateClient()" to fix this error.`)
    }
    return instance
  }
...
export class AltimateClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<AltimateClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    AltimateClient.__registry.set(this, args?.key)
  }
