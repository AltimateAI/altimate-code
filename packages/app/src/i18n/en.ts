export const dict = {
  ...
  "sidebar.gettingStarted.line1": "Connect the Altimate LLM Gateway to use Altimate's curated models.",
  "sidebar.gettingStarted.line2": "Or connect any provider — Claude, GPT, Gemini, and more.",
