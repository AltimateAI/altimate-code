...
const TIPS: Tip[] = [
  ...
  "Add {highlight}.md{/highlight} files to {highlight}.altimate-code/commands/{/highlight} to define reusable custom prompts",
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input",
  "Use backticks in commands to inject shell output (e.g., {highlight}`git status`{/highlight})",
  "Add {highlight}.md{/highlight} files to {highlight}.altimate-code/agents/{/highlight} for specialized AI personas",
  ...
  "Add {highlight}.ts{/highlight} files to {highlight}.altimate-code/plugins/{/highlight} for event hooks",
  "Use plugins to send OS notifications when sessions complete",
  "Create a plugin to prevent Altimate Code from reading sensitive files",
  "Use {highlight}altimate run{/highlight} for non-interactive scripting",
  "Use {highlight}altimate --continue{/highlight} to resume the last session",
  "Use {highlight}altimate run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}altimate serve{/highlight} for headless API access to Altimate Code",
  "Use {highlight}altimate run --attach{/highlight} to connect to a running server",
  "Run {highlight}altimate upgrade{/highlight} to update to the latest version",
  "Run {highlight}altimate auth list{/highlight} to see all configured providers",
  "Run {highlight}altimate agent create{/highlight} for guided agent creation",
  "Use {highlight}/oc{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}altimate github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}altimate debug config{/highlight} to troubleshoot configuration",
