export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Altimate Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Altimate Code er blevet downloadet. Vil du installere den og genstarte?",
