export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Altimate Code-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Altimate Code-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
