export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Altimate Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Altimate Code wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
