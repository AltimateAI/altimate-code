export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Altimate Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Altimate Code er lastet ned. Vil du installere den og starte på nytt?",
