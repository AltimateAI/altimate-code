export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji Altimate Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} Altimate Code. Czy chcesz ją zainstalować i uruchomić ponownie?",
