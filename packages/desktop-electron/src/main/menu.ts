...
export function createMenu(deps: Deps) {
  ...
  const template: Electron.MenuItemConstructorOptions[] = [
    ...
    },
    {
      label: "Help",
      submenu: [
        { label: "Altimate Code Documentation", click: () => shell.openExternal("https://altimate.ai/docs") },
        ...
        { type: "separator" },
        {
          ...
          click: () =>
            shell.openExternal("https://github.com/AltimateAI/altimate-code/issues/new?template=feature_request.yml"),
        },
        {
          label: "Report a Bug",
          click: () => shell.openExternal("https://github.com/AltimateAI/altimate-code/issues/new?template=bug_report.yml"),
        },
      ],
    },
  ]
