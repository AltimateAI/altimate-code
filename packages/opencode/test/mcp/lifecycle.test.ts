...
// altimate_change start — isolate the home dir to a fresh empty dir. MCP auto-discovers
// home-scoped MCP config (~/.claude.json etc.) on connect via raw os.homedir(), which bypasses
