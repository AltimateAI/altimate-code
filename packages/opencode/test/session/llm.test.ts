...
// altimate_change start — toolNamesFromMessages is a distinct helper from
// LLM.hasToolCalls (still used by session/llm.ts); upstream's rewritten test
// file dropped coverage for it, so we preserve fork's unit tests here.
