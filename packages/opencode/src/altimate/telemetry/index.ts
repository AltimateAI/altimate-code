...
export namespace Telemetry {
  ...
  export function maskString(s: string): string {
    return s
      ...
      .replace(/(^|[\s"'`=(,[{:;<])(?:(?:gs|s3[an]?|abfss?|wasbs?|adl|dbfs|hdfs):\/\/|file:\/{1,3})(?:[^\s'"`)\]},;>]|'(?=[\p{L}\p{N}_]))*(?:(?: (?:[\p{L}\p{M}\p{N}_.@+()‘’-]|'(?=[\p{L}\p{N}_]))+)+\/(?:[^\s'"`)\]},;>]|'(?=[\p{L}\p{N}_]))*)*(?: (?:[\p{L}\p{M}\p{N}_.@+()‘’-]|'(?=[\p{L}\p{N}_]))+\.[A-Za-z0-9]{1,8})?(?:(?<!\.[A-Za-z0-9]{1,8}) (?:[\p{L}\p{M}\p{N}_‘’-]|'(?=[\p{L}\p{N}_]))+(?=$|[.,;:)\]}!?]))?/giu, "$1<path>")
      .replace(/(^|[\s"'`=(,[{:;<])[A-Za-z]:[\\\/]Users[\\\/](?:[^\s'"`)\]},;>]|'(?=[\p{L}\p{N}_]))*(?:(?: (?:[\p{L}\p{M}\p{N}_.@+()‘’-]|'(?=[\p{L}\p{N}_]))+)+[\\\/](?:[^\s'"`)\]},;>]|'(?=[\p{L}\p{N}_]))*)*(?: (?:[\p{L}\p{M}\p{N}_.@+()‘’-]|'(?=[\p{L}\p{N}_]))+\.[A-Za-z0-9]{1,8})?(?:(?<!\.[A-Za-z0-9]{1,8}) (?:[\p{L}\p{M}\p{N}_‘’-]|'(?=[\p{L}\p{N}_]))+)?/giu, "$1<path>")
      .replace(/(^|[\s"'`=(,[{:;<])(?:[A-Za-z]:[\\\/]|\\\\)(?:[^\s'"`)\]},;>]|'(?=[\p{L}\p{N}_]))+(?:(?: (?:[\p{L}\p{M}\p{N}_.@+()‘’-]|'(?=[\p{L}\p{N}_]))+)+[\\\/](?:[^\s'"`)\]},;>]|'(?=[\p{L}\p{N}_]))*)*(?: (?:[\p{L}\p{M}\p{N}_.@+()‘’-]|'(?=[\p{L}\p{N}_]))+\.[A-Za-z0-9]{1,8})?(?:(?<!\.[A-Za-z0-9]{1,8}) (?:[\p{L}\p{M}\p{N}_‘’-]|'(?=[\p{L}\p{N}_]))+(?=$|[.,;:)\]}!?]))?/gu, "$1<path>")
      .replace(/(^|[\s"'`=(,[{:;<])\/(?:Users|home)\/(?:[^\s'"`)\]},;>]|'(?=[\p{L}\p{N}_]))*(?:(?: (?:[\p{L}\p{M}\p{N}_.@+()‘’-]|'(?=[\p{L}\p{N}_]))+)+\/(?:[^\s'"`)\]},;>]|'(?=[\p{L}\p{N}_]))*)*(?: (?:[\p{L}\p{M}\p{N}_.@+()‘’-]|'(?=[\p{L}\p{N}_]))+\.[A-Za-z0-9]{1,8})?(?:(?<!\.[A-Za-z0-9]{1,8}) (?:[\p{L}\p{M}\p{N}_‘’-]|'(?=[\p{L}\p{N}_]))+)?/giu, "$1<path>")
      .replace(/(^|[\s"'`=(,[{:;<])\/(?:[\p{L}\p{M}\p{N}_.@+-]+\/)+(?:[^\s'"`)\]},;>]|'(?=[\p{L}\p{N}_]))*(?:(?: (?:[\p{L}\p{M}\p{N}_.@+()‘’-]|'(?=[\p{L}\p{N}_]))+)+\/(?:[^\s'"`)\]},;>]|'(?=[\p{L}\p{N}_]))*)*(?: (?:[\p{L}\p{M}\p{N}_.@+()‘’-]|'(?=[\p{L}\p{N}_]))+\.[A-Za-z0-9]{1,8})?(?:(?<!\.[A-Za-z0-9]{1,8}) (?:[\p{L}\p{M}\p{N}_‘’-]|'(?=[\p{L}\p{N}_]))+(?=$|[.,;:)\]}!?]))?/gu, "$1<path>")
      .replace(/(^|[\s"'`=(,[{:;<])~\/(?:[^\s'"`)\]},;>]|'(?=[\p{L}\p{N}_]))*(?:(?: (?:[\p{L}\p{M}\p{N}_.@+()‘’-]|'(?=[\p{L}\p{N}_]))+)+\/(?:[^\s'"`)\]},;>]|'(?=[\p{L}\p{N}_]))*)*(?: (?:[\p{L}\p{M}\p{N}_.@+()‘’-]|'(?=[\p{L}\p{N}_]))+\.[A-Za-z0-9]{1,8})?(?:(?<!\.[A-Za-z0-9]{1,8}) (?:[\p{L}\p{M}\p{N}_‘’-]|'(?=[\p{L}\p{N}_]))+(?=$|[.,;:)\]}!?]))?/gu, "$1<path>")
      // altimate_change end
