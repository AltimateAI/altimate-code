...
const docs = `### Overview
Loads Altimate Code typography assets and mono nerd fonts.
...
export const Basic = {
  render: () => (
    <div style={{ display: "grid", gap: "8px" }}>
      <mod.Font />
      <div style={{ "font-family": "var(--font-family-sans)" }}>Altimate Code Sans Sample</div>
      <div style={{ "font-family": "var(--font-family-mono)" }}>Altimate Code Mono Sample</div>
    </div>
  ),
}
