...
- PR #15835: https://github.com/AltimateAI/altimate-code/pull/15835

## Do Not Translate (Locale Additions)

- `Altimate Code` (preserve casing in prose, docs, and UI copy)
...
- Keep product naming consistent: `Altimate Code` in prose, `opencode` only for exact technical identifiers
...
- Avoid changing `opencode` to `Altimate Code` inside commands, URLs, package names, or code literals
