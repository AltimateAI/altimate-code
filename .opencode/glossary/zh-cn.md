...
- PR #13942: https://github.com/AltimateAI/altimate-code/pull/13942

## Do Not Translate (Locale Additions)

- `Altimate Code` (preserve casing in prose; keep `opencode` only when it is part of commands, package names, paths, or code)
- `Altimate Code Zen`
- `Altimate Code CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `opencode` in prose when referring to the product name; use `Altimate Code`
