...
- The AI layer's output quality at scale: two live runs (four findings, all true positives, see 7a); no precision/recall measurement across many PRs yet, so no basis yet for flipping the Route C reasoning default.
