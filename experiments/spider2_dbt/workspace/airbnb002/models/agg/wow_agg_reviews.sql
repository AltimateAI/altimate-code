...
LEFT JOIN review_cte 
	/* joining by last 7 days range so we can get the last 7 days aggregation for each date */
...
SELECT
	*,
	/*using LAG with 6 days as offset to calculate week over week metrics */
